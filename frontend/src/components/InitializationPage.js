...
class InitializationPage extends Component {
  ...
  handleSubmit(event) {
    ...
    if (
      trainers < 1 ||
      validators < 1 ||
      Number.isNaN(trainers) ||
      Number.isNaN(validators)
    ) {
      alert(
    ...
    if (
      (syncScheme === 'BSP' || syncScheme === 'SSP') &&
      (Number.isNaN(period) || period < 1)
    ) {
              ...
              >
                <form onSubmit={this.handleSubmit}>
                  ...
                  <label>
                    ...
                    <select
                      name="syncScheme"
                      value={this.state.syncScheme}
                      onChange={this.handleChange}
                    >
                      <option selected value="BAP">
                        BAP
                      </option>
